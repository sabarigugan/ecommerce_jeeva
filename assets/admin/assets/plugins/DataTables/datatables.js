 ...
 *   https://datatables.net/download/#dt/dt-1.13.6/b-2.4.2/fc-4.3.0/fh-3.4.0/r-2.5.0/sc-2.2.0
 *
 * Included libraries:
 *   DataTables 1.13.6, Buttons 2.4.2, FixedColumns 4.3.0, FixedHeader 3.4.0, Responsive 2.5.0, Scroller 2.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.6/b-2.4.2/fc-4.3.0/fh-3.4.0/r-2.5.0/sc-2.2.0",
