...
$(document).ready(function() {
  $("#recommend").owlCarousel({
      ...
      autoplayHoverPause: true,
      nav: false,
      navText: ["<img src='<?php echo base_url(); ?>assets/images/fashion/left.png'>", "<img src='<?php echo base_url(); ?>assets/images/fashion/right.png'>"],
      dots: false,
      responsive:{
                 0:{
                     items:1
...
<script type="text/javascript">
         $(document).ready(function () {
             $(".top-menu ul.nav li a").click(function () {
                 $(".top-menu ul.nav li a ").removeClass("active");
    ...
    $(document).ready(function () {
        $('.btn-number1').click(function (e) {
            ...
            if (!isNaN(currentVal)) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('user/update_cart_qty'); ?>',
                    ...
                    error: function (error) {
                        console.error(error); // Log the error, you can handle errors here
                    }
                });
            }
        });
  ...
  <script>
         ...
         $(document).ready(function(){
             $("#owl-slider").owlCarousel({
                 ...
                 autoplayHoverPause: true,
                 nav: true,
                 navText: ["<img src='<?php echo base_url(); ?>assets/images/left.png'>", "<img src='<?php echo base_url(); ?>assets/images/right.png'>"]
