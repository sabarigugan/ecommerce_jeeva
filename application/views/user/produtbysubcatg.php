...
<div class="col-lg-12 col-xs-12 pull-left product-list-inner">
   <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9 col-xs-12 pull-left product-inner-right" id="subcatg">
            <div class="row" >
              <?php
      $listproductbysubsub = $this->madmin->listproductbysubsub($uri3_rpl);

      if (empty($listproductbysubsub)):
      ...
      <?php
          ...
          foreach ($listproductbysubsub as $listproductbysubsubArray):
              $pid = $listproductbysubsubArray->pid;
      ?>
        ...
        ?>
                          ...
                          <h3><a href="<?php echo site_url('user/product/'. $pid); ?>"><?php echo $listproductbysubsubArray->pname; ?></a></h3>
                      </div>
